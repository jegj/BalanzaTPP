...
proc vTclWindow.top36 {base} {
    ...
    wm geometry $top 720x500+376+154
    update
    # set in toplevel.wgt.
    global vTcl
    ...
    button $site_3_0.but48 \
        -activebackground {#d9d9d9} -activeforeground black \
        -background {#d9d9d9} -command reiniciar_servidor \
        -foreground {#000000} -highlightcolor black -text Reiniciar 
    vTcl:DefineAlias "$site_3_0.but48" "reiniciar_button" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.lab45 \
        -in $site_3_0 -x 500 -y 15 -width 57 -height 19 -anchor nw \
        -bordermode ignore 
    place $site_3_0.mes46 \
        -in $site_3_0 -x 570 -y 3 -width 101 -height 43 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but47 \
        -in $site_3_0 -x 30 -y 20 -width 177 -height 27 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but48 \
        -in $site_3_0 -x 30 -y 70 -width 177 -height 27 -anchor nw \
        -bordermode ignore 
    place $site_3_0.mes49 \
        -in $site_3_0 -x 380 -y 30 -width 187 -height 53 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 570 -y 48 -width 21 -height 19 -anchor nw \
        -bordermode ignore 
    place $site_3_0.mes52 \
        -in $site_3_0 -x 350 -y 80 -width 205 -height 23 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 559 -y 80 -width 36 -height 19 -anchor nw \
        -bordermode ignore 
    frame $top.fra40 \
    ...
    text $site_3_0.tex43 \
        ...
        -selectbackground {#c4c4c4} -selectforeground black -width 666 \
        -wrap word 
    ...
    place $site_3_0.tex43 \
        -in $site_3_0 -x 10 -y 40 -width 666 -height 266 -anchor nw \
        -bordermode ignore 
    ...
    ###################
    place $top.fra39 \
        -in $top -x 20 -y 10 -width 685 -height 115 -anchor nw \
        -bordermode ignore 
    place $top.fra40 \
        -in $top -x 20 -y 140 -width 685 -height 325 -anchor nw \
        -bordermode ignore 
